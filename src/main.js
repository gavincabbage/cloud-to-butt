const RULES = [
	{ regex: /\b[Ff][Cc] [Ss]chalke 04\b/g, replacement: 'FC Krautsalat 03+1' },
	...
	{ regex: /\b[Ff][aä]hrman\b/g, replacement: 'Fartman' },
	{ regex: /\b([[Dd]omenico )?[Tt]edesco\b/g, replacement: 'Papa Smurf' },
];
